  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <Divider />
        <List>
          {['Dashboard', 'Countries', 'History', 'Analysis'].map((text, index) => (
          ...
          {/* card to display total number of covid-19 cases */}
            <Card sx={{ maxWidth: 345 }}>
                ...
                <CardMedia
                    component="img"
                    height="194"
                    image="https://images.unsplash.com/photo-1611092028881-8b8b0b0b8b1a?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80"
                    alt="green iguana"
                />
                <CardContent>
